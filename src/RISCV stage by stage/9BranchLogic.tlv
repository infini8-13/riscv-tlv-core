...
\TLV
   ...
   $next_pc[31:0] =  $reset    ? '0           :
                     $taken_br ? $br_tgt_pc   :  //Changed reflected from section 7 - Branch Logic
                     $pc + 32'd4 ;
   $pc[31:0] = >>1$next_pc;
   ...
   // 7 Branch Logic
   //taken_br - Determines whether branch is taken
   ...
   //br_tgt_pc - Computes the current branch target
