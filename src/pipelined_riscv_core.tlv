...
\TLV
   ...
   |cpu
      ...
      @1
		 ...
		 // 3.1 Instruction Fields and Field Validation 	
   ...
   *failed = !clk || 1'b0;
   ...
   //  o CPU visualization
   |cpu
      m4+imem(@1)    // read stage
      m4+rf(@2, @3)  // read stage, write stage - if equal, no register bypass is required
      m4+dmem(@4)    // read/write stage
